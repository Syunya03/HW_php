...
$works = [
        ...
        [
         "name" => "Фельдшер скорой помощи",
        "dateStart" => "Август 2006",
        "dateEnd" => "Июнь 2021",
        "description" => "Описание работы фельдшером скорой помощи",  
        ],
        [
         "name" => "Исполняющий обязанности старшего фельдшера",
        "dateStart" => "Июнь 2021",
        "dateEnd" => "Сентябрь 2022",
        "description" => "Описание работы исполняющим обязанности старшего фельдшера",  
        ],
    ];
    ?>
